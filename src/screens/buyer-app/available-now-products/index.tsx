...
const AvailableNowProducts = ({navigation}: NativeStackScreenProps<any>) => {
      ...
      <ScreenWrapper statusBarColor={AppColors.primary} barStyle="dark-content">
        <View style={styles.container}>
          <Header
            ...
            title={selectedLanguage?.availableNow_screen?.AvailableNow_Title}
            onFilterIconPress={() =>
              navigation.navigate(ScreenNames.FILTERPRODUCTSSCREEN)
            }
          />
          <FlatList
...
export default AvailableNowProducts;
